#!/bin/bash -l
#SBATCH --job-name=hnav-curr-penalty
...
# ---------------------------------------------------------------
echo "=== PHASE 2: Curriculum fine-tune (discrete, store_cost=0.02) ==="
python -m hopfield_nav.train \
    --encoder_checkpoint encoders/confused-sweep-160/encoder_final.pt \
    --encoder_gain 3.0 \
    ...
    --eval_every 50 \
    --save_every 500 \
    --save_dir checkpoints/curriculum_discrete_penalty \
    --seed 42 \
    --device cpu
...
# ---------------------------------------------------------------
echo "=== PHASE 3: Curriculum fine-tune (continuous, store_cost=0.02) ==="
python -m hopfield_nav.train \
    --encoder_checkpoint encoders/confused-sweep-160/encoder_final.pt \
    --encoder_gain 3.0 \
    ...
    --eval_every 50 \
    --save_every 500 \
    --save_dir checkpoints/curriculum_continuous_penalty \
    --seed 42 \
    --device cpu
