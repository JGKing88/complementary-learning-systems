"""Tests for hopfield_nav.phase_decoding_v2.
...
from hopfield_nav.phase_decoding_v2.classifier import (
    MLPPhaseClassifier, extract_hidden, train_mlp,
)
from hopfield_nav.phase_decoding_v2.collect_trajectory import (
    TwoEpisodeTrajectoryCollector,
)
from hopfield_nav.phase_decoding_v2.collect_trials import (
    ExploreExploitCollector, TrialsDataset,
)
from hopfield_nav.phase_decoding_v2.metrics import (
    decodability, parallelism_score, within_arena_baseline,
)
from hopfield_nav.phase_decoding_v2.rollout import EnvBundle, RolloutEngine
from hopfield_nav.phase_decoding_v2.splits import (
    all_splits,
    split_loo,
...
def _synthetic_trials(n_arenas=4, n_per_phase=20, hidden=8, sep=5.0, seed=0):
    ...
    from hopfield_nav.phase_decoding_v2.collect_trials import TrialData
...
class TestEndToEnd:
    def test_exp1_pipeline(self, tmp_path: Path):
        from hopfield_nav.phase_decoding_v2.exp1 import _evaluate
    ...
    def test_viz_bars_writes_png(self, tmp_path: Path):
        from hopfield_nav.phase_decoding_v2.viz import plot_bars
        results = {
    ...
    def test_viz_bars_grouped_writes_png(self, tmp_path: Path):
        from hopfield_nav.phase_decoding_v2.viz import plot_bars_grouped
        a = {
    ...
    def test_plot_module_loads_metrics_json(self, tmp_path: Path):
        from hopfield_nav.phase_decoding_v2.plot import _load_results, _resolve
