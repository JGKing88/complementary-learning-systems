...
MAPPINGS=(
    ...
    "wandb:wandb"
    "hopfield_nav/final_plotting/histories:histories"
    "hopfield_nav/final_plotting/scaffold_cache:scaffold_cache"
    "hopfield_nav/final_plotting/figures:figures/final_plotting"
    "hopfield_nav/final_plotting/final_figures:figures/final"
    "hopfield_nav/final_plotting/model_comparison:figures/model_comparison"
    "hopfield_nav/phase_decoding_v2/results:results/phase_decoding_v2"
    "hopfield_nav/phase_decoding:results/phase_decoding_v1"
