...
#   python -m analysis.phase_decoding.plot \
#       --metrics A.json B.json --labels trained random --out cmp.png

##METRICS=$CLS_RESULTS/phase_decoding_v2/exp1_phase_a_only_glamorous-field-97_phase_a_u360_stochastic_random_init_seed0 bash /home/jackking/cls/analysis/phase_decoding/run_plot.sh
