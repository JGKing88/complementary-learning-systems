...
In standard VectorHash (``hopfield_nav.world.scaffold.VectorHash``):
...
def build_common(args, encoder_lambdas: list[int]) -> ScaffoldCommon:
...
def main() -> None:
    ...
    # Stash the resolved lambdas so build_common can read them via args.
