...
ENCODERS = [
    ("v35 (gain 3.70)", str(encoders_dir() / "run_20260422_185816/encoder_best.pt"), None),
    ("L7-s42 (gain 100)",
     str(sweeps_dir() / "w53_attract_knee/004_att16_seed=42/encoder_final.pt"), None),
    ("untrained (gain 5)", str(encoders_dir() / "untrained_mlp.pt"), 0.25),
]
