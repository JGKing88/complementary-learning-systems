...
# matplotlib is imported inside the plot_* functions below: everything else
# here is plain numpy, and test_layering keeps the figure stack out of library
# packages' import time.
